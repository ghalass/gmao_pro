  ...
  pages: {
    ...
    typeorganes: {
      ...
      table: {
        name: "اسم النوع",
        associatedParcs: "المتنزهات المرتبطة",
        associatedOrganes: "الأعضاء المرتبطة",
        noTypes: "لا يوجد نوع عضو مُكوّن",
        parcs: "متنزهات",
        organes: "أعضاء",
        noParc: "لا يوجد متنزه",
        noOrgane: "لا يوجد عضو",
      },
    },
    organes: {
      title: "إدارة الأعضاء",
      subtitle: "{count} عضو{plural} مُسجّل{plural}",
      table: {
        name: "اسم العضو",
        type: "نوع العضو",
        ...
        status: "الحالة",
        creationDate: "تاريخ الإنشاء",
        noOrganes: "لا يوجد أعضاء مُكوّنة",
        active: "نشط",
        inactive: "غير نشط",
      },
    },
    ...
    typeconsommationlubs: {
      title: "أنواع استهلاك مواد التشحيم",
      subtitle: "{count} نوع{plural} مُكوّن{plural}",
      table: {
        name: "اسم النوع",
        associatedParcs: "المتنزهات المرتبطة",
        noTypes: "لا توجد أنواع مُكوّنة",
        parcs: "متنزهات",
      },
    },
  },
