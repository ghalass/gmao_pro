...
const EditEntreprise = ({
  ...
  const form = useForm({
    defaultValues: {
      ...
      lang: entreprise?.lang || "fr",
      active: entreprise?.active !== undefined ? entreprise.active : true,
    },
    onSubmit: async ({ value }) => {
      try {
        ...
        const hasChanges =
          value.name !== entreprise?.name ||
          value.lang !== entreprise?.lang ||
          value.active !== entreprise?.active;
        ...
        const response = await apiFetch(
          API.ENTREPRISES.ENTREPRISE_UPDATE(entreprise.id),
          {
        ...
        >
          ...
          <FieldGroup className="gap-4 py-4">
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              />
              <Label
                htmlFor="edit-entreprise-active"
