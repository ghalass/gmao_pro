...
interface RoleUpdateImportProps {
  onImportComplete: (result: any) => void;
}

export function RoleUpdateImport({ onImportComplete }: RoleUpdateImportProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/roles/update-import", {
        method: "POST",
        body: formData,
      });
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      link.href = url;
      link.download = "roles_update_template.xlsx";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold">Modification de rôles</h3>
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
            ...
            <li>Le nom est obligatoire pour identifier le rôle à modifier</li>
