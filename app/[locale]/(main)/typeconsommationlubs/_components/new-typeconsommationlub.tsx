  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      try {
        ...
        const response = await apiFetch(API.TYPECONSOMMATIONLUBS.CREATE, {
          method: methods.POST,
          body: {
            name: value.name,
  ...
  return (
    <Dialog open={modalOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
        ...
        >
          <DialogHeader>
            <DialogTitle>Créer un nouveau type de consommation</DialogTitle>
            <DialogDescription>
              Définissez un type de consommation de lubrifiant et associez-le à
              des parcs.
            </DialogDescription>
          </DialogHeader>
...
export default NewTypeconsommationlub;
